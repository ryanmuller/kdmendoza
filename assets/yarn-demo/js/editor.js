var editor = (function() {
	...
	var textOptions, optionsBox, boldButton, italicButton, quoteButton, highlightButton, urlButton, urlInput;
        
        rangy.init();
        var css = rangy.modules.CssClassApplier;
        applier = rangy.createCssClassApplier("highlight_text", {
                    elementTagName: "span",                    
        });
	...
	function bindElements() {
		...
		italicButton.onclick = onItalicClick;
                ...
                highlightButton = textOptions.querySelector( '.highlight' );
...
/*
	...
	function updateBubbleStates() {
		...
		if ( hasNode( currentNodeList, 'I') ) {
			...
			highlightButton.className = "highlight_text active"
		} else {
			highlightButton.className = "highlight_text"
		}
