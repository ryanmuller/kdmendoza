...
function addSection(title, subtitle, content)
{
    ...
    var section_title = 'Type your title ' + (section_count + 1);
 //   section_title = 'Type your title ';
    /*if (title != undefined)
    ...
    $('.default_text').each(function() {
        ...
        if ($(this).attr("class") != "content default_text") {
            ...
            $(this).blur(function() {
                ...
                if($(this).html() == "") {                    
                    id = $(this).attr("id");    
                    $('#plot_p_' + getId(id)).html("Type your title");
...
function addPlotPoint(title, subtitle)
{
  ...
  function createAlternative(title1, subtitle1, alt1, title2, subtitle2, alt2){         
    ...
    var placeholder = 'Type your title ' + section_count;
    ...
    var placeholder = 'Type your title';
    ...
    text += '</div>';   
      /*
    if ($('#alt2_'+(section_count-1)).length == 0)
        $('.navigation').after(text);
    else*/   
        $('#alt2_'+(section_count-1)).after(text);
...
function initialize()
{
   ...
   /* $("#alt2_" + clickedDot).remove();
    ...
    addSection(title, subtitle, content);
    addPlotPoint(title, subtitle);
    createAlternative();             
    
    title = "The Red-Headed League";
    subtitle = "Calling Upon a Friend";
    content = "I could not help laughing at the ease with which he explained his process of deduction. “When I hear you give your reasons,” I remarked, “the thing always appears to me to be so ridiculously simple that I could easily do it myself, though at each successive instance of your reasoning I am baffled until you explain your process. And yet I believe that my eyes are as good as yours.”</p><p>“Quite so,” he answered, lighting a cigarette, and throwing himself down into an armchair. “You see, but you do not observe. The distinction is clear. For example, you have frequently seen the steps which lead up from the hall to this room.”</p><p>“Frequently.”</p><p>“How often?”</p><p>“Well, some hundreds of times.”</p><p>“Then how many are there?”</p><p>“How many? I don’t know.”</p><p>“Quite so! You have not observed. And yet you have seen. That is just my point. Now, I know that there are seventeen steps, because I have both seen and observed. By-the-way, since you are interested in these little problems, and since you are good enough to chronicle one or two of my trifling experiences, you may be interested in this.” He threw over a sheet of thick, pink-tinted note-paper which had been lying open upon the table. “It came by the last post,” said he. “Read it aloud.” </p>The note was undated, and without either signature or address. “There will call upon you to-night, at a quarter to eight o’clock,” it said, “a gentleman who desires to consult you upon a matter of the very deepest moment. Your recent services to one of the royal houses of Europe have shown that you are one who may safely be trusted with matters which are of an importance which can hardly be exaggerated. This account of you we have from all quarters received. Be in your chamber then at that hour, and do not take it amiss if your visitor wear a mask.” “This is indeed a mystery,” I remarked. “What do you imagine that it means?”</p><p>“I have no data yet. It is a capital mistake to theorize before one has data. Insensibly one begins to twist facts to suit theories, instead of theories to suit facts. But the note itself. What do you deduce from it?”";
    ...
    subtitle = "'My Dear Fellow'";
    content = "A man entered who could hardly have been less than six feet six inches in height, with the chest and limbs of a Hercules. His dress was rich with a richness which would, in England, be looked upon as akin to bad taste. Heavy bands of astrakhan were slashed across the sleeves and fronts of his doublebreasted coat, while the deep blue cloak which was thrown over his shoulders was lined with flamecoloured silk and secured at the neck with a brooch which consisted of a single flaming beryl. Boots which extended halfway up his calves, and which were trimmed at the tops with rich brown fur, completed the impression of barbaric opulence which was suggested by his whole appearance. He carried a broad-brimmed hat in his hand, while he wore across the upper part of his face, extending down past the cheekbones, a black vizard mask, which he had apparently adjusted that very moment, for his hand was still raised to it as he entered. From the lower part of the face he appeared to be a man of strong character, with a thick, hanging lip, and a long, straight chin suggestive of resolution pushed to the length of obstinacy. “You had my note?” he asked with a deep harsh voice and a strongly marked German accent. “I told you that I would call.” He looked from one to the other of us, as if uncertain which to address. “Pray take a seat,” said Holmes.";
    
    addSection(title, subtitle, content);
    addPlotPoint(title, subtitle);
    createAlternative();       
    
    content = "Our visitor glanced with some apparent surprise at the languid, lounging figure of the man who had been no doubt depicted to him as the most incisive reasoner and most energetic agent in Europe. Holmes slowly reopened his eyes and looked impatiently at his gigantic client.</p><p>“If your Majesty would condescend to state your case,” he remarked, “I should be better able to advise you.” The man sprang from his chair and paced up and down the room in uncontrollable agitation.</p> <p>Then, with a gesture of desperation, he tore the mask from his face and hurled it upon the ground. “You are right,” he cried; “I am the King. Why should I attempt to conceal it?”";
    title = "The Boscombe Mystery";
    subtitle = "An Early Morning";
    ...
    subtitle = "A Telegram Arrives";
    
    addSection(title, subtitle);
    addPlotPoint(title, subtitle);
    createAlternative();         
